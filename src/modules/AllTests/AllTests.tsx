                ...
                <div className='answersAndImage'>
                    <form>
                        <div className='answers'>
                            ...
                            <label htmlFor='giveAnswer'>
                                <input type='radio' name='giveAnswer'/> Локальные видно везде, глобальные только внутри функций
                            </label>
                            <label htmlFor='giveAnswer'>
                                <input type='radio' name='giveAnswer'/> Глобальные можно переопределить, локальные нельзя
                            </label>
                            <label htmlFor='giveAnswer'>
                                <input type='radio' name='giveAnswer'/> Глобальные можно переопределить, локальные нельзя
                            </label>
